...
#define COLOR_DEFAULT                                                          \
	(-1) /* ncurses extension to use default color, see                        \
...
struct colours cols = {
	...
	NO_BOLD,	   NO_BLINK, /* normal */
	COLOR_GREEN,   COLOR_WHITE,
	BOLD,		   NO_BLINK, /* selected menu */
	COLOR_GREEN,   COLOR_BLACK,
	BOLD,		   NO_BLINK, /* menu */
	COLOR_BLUE,	   COLOR_WHITE,
	BOLD,		   NO_BLINK, /* selected note */
	COLOR_BLUE,	   COLOR_BLACK,
	BOLD,		   NO_BLINK, /* note */
	COLOR_GREEN,   COLOR_BLUE,
	BOLD,		   NO_BLINK, /* top line */
	COLOR_GREEN,   COLOR_BLUE,
	BOLD,		   NO_BLINK, /* bottom line */
	COLOR_YELLOW,  COLOR_BLACK,
	BOLD,		   NO_BLINK, /* manual bold */
	COLOR_WHITE,   COLOR_BLACK,
	BOLD,		   NO_BLINK, /* manual italic */
	COLOR_MAGENTA, COLOR_BLACK,
	BOLD,		   NO_BLINK, /* url */
	COLOR_MAGENTA, COLOR_GREEN,
	NO_BOLD,	   NO_BLINK, /* url selected */
	COLOR_WHITE,   COLOR_BLACK,
	BOLD,		   NO_BLINK, /* info highlight(quoted text) */
	COLOR_YELLOW,  COLOR_BLACK,
	BOLD,		   NO_BLINK /* search highlight */
};
...
#else
				fprintf(stderr,
						"COLOR_DEFAULT is not supported on this system\n");
				return 1;
#endif
